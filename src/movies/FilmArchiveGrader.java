...
filmArchiveClass.getMethod("getSorted", EMPTY_TYPE_LIST); // getSorted()
...
Method addMeth = filmArchiveClass.getMethod("add", MOVIE_TYPE_LIST); // add()
...
Method getTestMoviesMeth = movieClass.getMethod("getTestMovies",
...
Method getTitleMeth = movieClass.getMethod("getTitle",
...
Method getYearMeth = movieClass.getMethod("getYear",
